...
model_path = "5Epoch_1e_6"  # Change this to your model's directory name
...
df_aime24.to_csv("aime24_1e6_sft.csv", index=False)
...
df_math500.to_csv("math500_1e6_sft.csv", index=False)
...
df_gpqa.to_csv("gpqa_1e6_sft.csv", index=False)
