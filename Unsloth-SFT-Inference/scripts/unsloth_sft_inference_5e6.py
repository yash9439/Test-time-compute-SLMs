...
model_path = "5Epoch_5e_6"  # Change this to your model's directory name
...
df_aime24.to_csv("aime24_5e6_sft.csv", index=False)
...
df_math500.to_csv("math500_5e6_sft.csv", index=False)
...
df_gpqa.to_csv("gpqa_5e6_sft.csv", index=False)
